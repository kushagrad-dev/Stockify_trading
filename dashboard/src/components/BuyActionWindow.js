...
const BuyActionWindow = ({ uid, mode = "BUY" }) => {
  ...
  const [stockPrice] =
    ...
    useState(currentStockPrice);

  const [ownedQuantity, setOwnedQuantity] =

    useState(null);

  const [isLoadingHolding, setIsLoadingHolding] =
    ...
    const fetchHolding = async () => {
      ...
      if (!token) {
        ...
        setError(
          ...
          "Please login before selling shares."
  ...
  const handleActionClick = async () => {
    ...
    if (
      ...
      setError(
        ...
        "Current stock price is not available."
    ...
    if (isSellMode) {
      ...
      if (ownedQuantity === null) {
        ...
        setError(
          ...
          "Please wait while we check your holdings."
  ...
  const formattedPrice =
    ...
    Number(stockPrice || 0).toLocaleString(
  ...
  const formattedTotal =
    ...
    Number(marginRequired || 0).toLocaleString(
